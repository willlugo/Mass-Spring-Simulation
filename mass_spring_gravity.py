...
# Values relating to if the simulation should employ gravity or not
gravity = True
g = 9.81
...
def main():
    ...
    spring4 = spring(mass1, mass3, 10, 10)
    spring5 = spring(wall2, mass3, 5, 20)
